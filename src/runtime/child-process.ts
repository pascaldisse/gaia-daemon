// Shared child-process primitive for the harness runtimes. Every harness spawns
// a child, reads its stdout as newline-delimited records, and watches stderr —
// only the framing ON TOP differs (Claude's NDJSON parse + stdin prompt, Codex's
// JSON-RPC, the runner host's stderr forwarding + breaker logic). This wraps the
