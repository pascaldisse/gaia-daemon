...
function renderTranscript() {
  ...
  // pi ext lifecycle + generic harness events are DEBUG data (Pascal 09-05): kept
  // in state (extLifecycle / harnessEvents) for devtools, never rendered here.
  // ui.widget rows: `aboveEditor` at the TOP of the transcript, `belowEditor` bottom.
