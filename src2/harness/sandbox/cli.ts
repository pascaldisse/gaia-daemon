...
// Side-effect imports: this runs in a fresh process, so the backends must
// self-register before a launch can resolve.
import "./none.js";
import "./seatbelt.js";
import { resolveSandboxLaunch, type SandboxPolicy } from "./spec.js";
