...
# Seconds of user silence before the bot is nudged to speak on its own.
# Overridable so embedding apps (e.g. GAIA) can tune or effectively disable it.
USER_SILENCE_TIMEOUT = float(os.environ.get("KYUTAI_USER_SILENCE_TIMEOUT", "7.0"))
