...
- [Pi skill instructions](/Users/USER/.codex/skills/pi/SKILL.md)
- [pi-agent wrapper](/Users/USER/.codex/skills/pi/scripts/pi-agent)
- [pi-agent implementation](/Users/USER/.codex/skills/pi/scripts/pi-agent.mjs)
- [Pi orchestrator prompt](/Users/USER/.codex/skills/pi/codex-orchestrator.md)

Skill repo:

```text
/Users/USER/.codex/skills/pi
...
- [Agent runtime interface](/Users/USER/projects/gaia-daemon/src/runtime/types.ts)
- [Pi runtime](/Users/USER/projects/gaia-daemon/src/runtime/pi-runtime.ts)
- [GAIA controller](/Users/USER/projects/gaia-daemon/src/app/gaia-controller.ts)
- [Turn runner](/Users/USER/projects/gaia-daemon/src/app/turn-runner.ts)
- [Prompt assembly](/Users/USER/projects/gaia-daemon/src/runtime/prompt-assembly.ts)
- [Agent definition type](/Users/USER/projects/gaia-daemon/src/agents/types.ts)
- [Agent registry](/Users/USER/projects/gaia-daemon/src/agents/registry.ts)
- [Workspace config type](/Users/USER/projects/gaia-daemon/src/workspace/types.ts)
- [Room state](/Users/USER/projects/gaia-daemon/src/room/state.ts)
- [Transcript storage](/Users/USER/projects/gaia-daemon/src/room/transcript.ts)
- [Web server/SSE](/Users/USER/projects/gaia-daemon/src/web/server.ts)
- [Frontend SSE handling](/Users/USER/projects/gaia-daemon/web/src/events.ts)
- [Room panel rendering](/Users/USER/projects/gaia-daemon/web/src/render.ts)
- [Slash command parsing](/Users/USER/projects/gaia-daemon/src/app/commands.ts)
...
- [web/src/state.ts](/Users/USER/projects/gaia-daemon/web/src/state.ts): add `summons`, `selectedSummonId`, `selectedSummon`.
- [web/src/events.ts](/Users/USER/projects/gaia-daemon/web/src/events.ts): handle `summon-start`, `summon-event`, `summon-end`.
- [web/src/render.ts](/Users/USER/projects/gaia-daemon/web/src/render.ts): render summon list and drawer.
- [web/src/api.ts](/Users/USER/projects/gaia-daemon/web/src/api.ts): add summon endpoints.
...
Update [src/app/commands.ts](/Users/USER/projects/gaia-daemon/src/app/commands.ts):
...
Current custom tool creation is in [src/runtime/pi-runtime.ts](/Users/USER/projects/gaia-daemon/src/runtime/pi-runtime.ts), where `memory` and `recall` are appended based on `agent.tools`.
