...
import "../src2/harness/index.js"; // registers pi/claude/codex — hints derive from the registry
import { buildFileHints, sdkThinkingLevels, sdkToolNames, type FieldHint, type FileHints, type HintSources } from "../src2/services/hints.js";
