...
import {
  ...
  sandboxBackendIds,
} from "../src2/harness/sandbox/spec.js";
import { buildSeatbeltProfile } from "../src2/harness/sandbox/seatbelt.js";
import "../src2/harness/sandbox/none.js";
...
test("__sandbox-exec: backend none runs the child directly and propagates its exit code", async () => {
  const { runSandboxExec } = await import("../src2/harness/sandbox/cli.js");
